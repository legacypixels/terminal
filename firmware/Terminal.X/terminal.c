 ...
 * 3.2.0_lp-5: Enable signal inversion and clarify options
 */
...
#define PRODUCT_VERSION "Version 3.2.0_lp-5\r\n"
#define PRODUCT_COPYRIGHT\
  "Copyright (C) 2021-2024 Legacy Pixels LLC\r\n"                                   \
  ...
  "https://github.com/legacypixels/terminal\r\n"
